...
const SignUp = () => {
  ...
  const handleSubmit = async (values, resetForm) => {
    ...
    try {
      ...
      await signup(username, first_name, last_name, email, password);
      resetForm();
      setAgree(false);
  ...
  const googleLogin = async () => {
    router.push(
      "https://accounts.google.com/o/oauth2/v2/auth?client_id=587032720364-7q3gfn5sfqdi7uhtk84obvs3f562m3mt.apps.googleusercontent.com&redirect_uri=http://localhost:3000/google-auth/&response_type=code&scope=email%20profile&access_type=offline&include_granted_scopes=true&prompt=consent&state={STATE}"
    );
  };
    ...
    <div className="login-container">
      <div className="login-left">
        ...
        <div className="login-text">
          <h1>Welcome !</h1>
          <p>
            Join APEX ODR and take the first step toward safeguarding your
            digital world.
          </p>
        </div>
      </div>
