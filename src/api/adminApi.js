...
export const forgotPasswordAPI = new APIBase({
  baseURL: `${BASE_API_URL}/store-owner/password-reset/`,
});

export const PasswordResetAPI = new APIBase({
  baseURL: `${BASE_API_URL}/store-owner/password-reset-confirm/`,
});
...
export const WhatsappQrAPI = new APIBase({
  baseURL: `${BASE_API_URL}/store-owner/whatsapp-qr-code/`,
});
